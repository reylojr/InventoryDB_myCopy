...
public class DbDriver {
     ...
     */
    public DbDriver(int hostIP, int hostPort, String databaseName, String dbUser, String dbPass) throws SQLException {

        // Create the database connection
        this.dbConn = DriverManager.getConnection(buildConnString(hostIP, hostPort, databaseName), dbUser, dbPass);
    }
     ...
     * @see DriverManager
     */
    private String buildConnString(int hostIP, int hostPort, String databaseName) {
